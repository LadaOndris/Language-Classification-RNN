...
if __name__ == "__main__":
    number_of_files = 1 #437
    train_size_percent = 10
    ...
    train_eng = train_eng[:10]    
    train_noneng = train_noneng[:10]    
    test_eng = test_eng[:10]    
    test_noneng = test_noneng[:10] 
    ...
    np.savetxt("train_set_10.csv", train, delimiter=":::", fmt="%s", encoding="ISO-8859-1")
    np.savetxt("test_set_10.csv", test, delimiter=":::", fmt="%s", encoding="ISO-8859-1") 
